...
parent: Methods
has_children: false
title: ImageButton.SetImage Method
nav_order: 7
permalink: /package/extension4/imagebutton/methods/setimage
---
# {{ page.title }}
...
<table>
  ...
  <tr>
    ...
    ImageButton1.SetImage(ImageList1.GetImage(0));
    ImageButton2.SetImage("img/sample.png");
    </pre></code></td>
  </tr>
  <tr>
    <td>Related item</td>
    <td colspan="2"><a href="/package/extension4/imagebutton/methods/resetimage">ResetImage</a> method<br><a href="/package/extension4/image">Image</a>, <a href="/package/extension4/imagelist">ImageList</a> class</td>
  </tr>
</table>